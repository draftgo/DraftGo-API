...
export function ModelMutateDrawer({
  ...
  const modelSettings = useMemo(() => {
    ...
    const defaultModelSettings: ModelSettings = {
      ...
      'monitor_setting.recovery_high_priority_minutes': 2,
      'monitor_setting.recovery_high_priority_threshold': 10,
      'monitor_setting.recovery_probation_seconds': 60,
      'monitor_setting.recovery_worker_count': 4,
      'monitor_setting.recovery_max_output_tokens': 16,
      'monitor_setting.recovery_daily_probe_budget': 200,
