...
func InitEnv() {
	...
	ChannelTestDefaultTimeout = GetEnvOrDefault("CHANNEL_TEST_TIMEOUT", 30)
	...
	// Whether to mask upstream provider error messages from API users
	MaskUpstreamErrors = GetEnvOrDefaultBool("MASK_UPSTREAM_ERRORS", true)
