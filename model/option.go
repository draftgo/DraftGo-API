...
func InitOptionMap() {
	...
	common.OptionMap["GroupFallbackModels"] = setting.GroupFallbackModels2JSONString()
	...
	common.OptionMap["SessionCookieCoverSubdomainEnabled"] = strconv.FormatBool(common.SessionCookieCoverSubdomainEnabled)
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" || key == "SMTPInsecureSkipVerify" {
		...
		case "SessionCookieCoverSubdomainEnabled":
			common.SessionCookieCoverSubdomainEnabled = boolValue
	...
	case "GroupFallbackModels":
		err = setting.UpdateGroupFallbackModelsByJSONString(value)
