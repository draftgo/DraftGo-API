...
func GetStatus(c *gin.Context) {
	...
	data := gin.H{
		...
		"ModelRequestRateLimitEnabled":         common.OptionMap["ModelRequestRateLimitEnabled"],
		"ModelRequestRateLimitDurationMinutes": common.OptionMap["ModelRequestRateLimitDurationMinutes"],
		"ModelRequestRateLimitGroup":           common.OptionMap["ModelRequestRateLimitGroup"],
		...
		"HeaderNavCustomLinks": common.OptionMap["HeaderNavCustomLinks"],
