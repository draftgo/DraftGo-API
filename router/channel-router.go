...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodGet, path: "/recovery", permission: authz.ChannelRead, handler: controller.GetChannelRecoveryStates},
	{method: http.MethodPost, path: "/recovery/:channel_id/:key_index/probe", permission: authz.ChannelOperate, handler: controller.ProbeChannelRecoveryNow},
	{method: http.MethodPost, path: "/recovery/:channel_id/:key_index/reset", permission: authz.ChannelOperate, handler: controller.ResetChannelRecovery},
