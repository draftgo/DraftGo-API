...
func SetupContextForToken(c *gin.Context, token *model.Token, parts ...string) error {
	...
	common.SetContextKey(c, constant.ContextKeyTokenFallbackModelEnabled, token.FallbackModelEnabled)
	common.SetContextKey(c, constant.ContextKeyTokenFallbackModels, token.GetFallbackModels())
	if token.AutoGroups != "" {
